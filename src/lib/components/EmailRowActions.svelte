...
>
	<button
		...
		title="Archive"
		aria-label="Archive"
		class="p-1.5 rounded-md hover:bg-surface text-text-secondary hover:text-text transition-colors cursor-pointer disabled:opacity-50"
	>
	...
	{#if hasReminder}
		<button
			...
			aria-label="Unsnooze"
			class="p-1.5 rounded-md hover:bg-surface text-accent-fg hover:text-text transition-colors cursor-pointer disabled:opacity-50"
		>
	...
	{:else}
		<div class="relative">
			<button
				...
				class="p-1.5 rounded-md hover:bg-surface transition-colors cursor-pointer disabled:opacity-50 {pickerOpen ? 'text-accent-fg bg-accent/10' : 'text-text-secondary hover:text-text'}"
			>
	...
	<button
		...
		title="Delete"
		aria-label="Delete"
		class="p-1.5 rounded-md hover:bg-surface text-text-secondary hover:text-danger transition-colors cursor-pointer disabled:opacity-50"
	>
